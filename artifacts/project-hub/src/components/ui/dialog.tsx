...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    {/* Flex-center the content instead of translate(-50%,-50%): a fractional
        translate lands the panel on a half-pixel and the browser renders its
        text blurry. Flex centering keeps it on whole pixels — always crisp. */}
