...
export function StatusSelect({
  ...
  return (
    <select
      ...
      disabled={disabled}
      className="text-xs rounded-full px-2 py-0.5 font-semibold border-0 outline-none cursor-pointer appearance-none"
      style={{
...
export function PrioritySelect({
  ...
  return (
    <select
      ...
      onChange={e => onChange(e.target.value)}
      disabled={disabled}
      className="text-xs rounded-full px-2 py-0.5 font-bold border-0 outline-none cursor-pointer appearance-none"
      style={{
