...
export function RFPTemplateSection({ projectId }: { projectId: number }) {
  ...
  return (
    ...
    >
      <p className="text-sm font-bold text-blue-900">RFP Template Generator</p>
      ...
      {alreadyGenerated || generated ? (
        <div className="space-y-2">
          <div className="rounded-xl p-3 text-center" style={{ background: "#ECFDF5" }}>
            <p className="text-sm font-bold text-emerald-700">✓ RFP Document generated from URS and on file</p>
          </div>
          <button
            onClick={generateRFPTemplate}
            className="w-full py-1.5 rounded-xl text-xs font-semibold text-blue-700 border border-blue-300 transition-all hover:bg-blue-50"
          >
      ...
      {(ursScope || ursRequirements) && (
        <div className="rounded-lg p-2.5 text-xs text-blue-700 bg-blue-50 border border-blue-100">
