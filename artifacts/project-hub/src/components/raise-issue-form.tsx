...
export function RaiseIssueForm({ projectId }: { projectId: number }) {
  ...
  const [form, setForm] = useState({ milestoneId: "", taskId: "", subtaskId: "", title: "", description: "", assignee: "" });
    ...
    createIssue.mutate(
      ...
      },
      {
        onSuccess: () => {
          ...
          setForm({ milestoneId: form.milestoneId, taskId: form.taskId, subtaskId: form.subtaskId, title: "", description: "", assignee: "" });
